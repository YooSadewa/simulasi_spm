...
<head>
    ...
    <link rel="stylesheet" href="../admin/style/stylecetak.css">
</head>
<body>
    <div class="form-container" style="padding-right: 40px;">
        <h1>Hasil Pengaduan Anda dan Tanggapannya</h1>
        <form action="#" method="post">
            ...
            <img src="../masyarakat/foto_laporan/<?=$row['foto']?>" alt=""  style="width:fit-content; height:100px;">
            ...
            <a href="tabelpengaduan.php">Kembali ke Halaman Awal</a>
        </form>
    </div>
</body>
</html>
